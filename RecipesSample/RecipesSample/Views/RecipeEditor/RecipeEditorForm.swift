...
struct RecipeEditorForm: View {
    ...
    var body: some View {
        Form {
            ...
            Section {
                TextField(text: $config.recipe.servings,
                          prompt: Text("4-6")) {
                    Text("Servings")
                }
                TextField(text: $config.recipe.prepTimeAsText,
                          prompt: Text("in seconds")) {
                    Text("Prep time")
                }
                TextField(text: $config.recipe.cookTimeAsText, prompt: Text("int seconds")) {
                    Text("Cook time")
                }
